...
public class CameraDirector : MonoBehaviour
{
    ...
    [SerializeField] private LayerMask cutSceneCullingMask;
    ...
    void Awake()
    {
        SetCamera(CameraList.IntroCam);

    }

    private void Start()
    {
        if(cameraBrain != null) cameraBrain = Camera.main.gameObject.GetComponent<CinemachineBrain>();
    }
